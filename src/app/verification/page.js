          ...
          <>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-4 py-2  text-white border border-gray-600 rounded focus:outline-none focus:ring-1 focus:ring-[#840029]"
              />
            </div>
        ...
        return (
          <>
            ...
            <div className="mt-6 mb-4">
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  className="w-full px-4 py-2  border border-gray-600 rounded focus:outline-none focus:ring-1 focus:ring-[#840029]"
                />
              </div>
            ...
            <div className="text-center mt-2">
              <a href="#" className="text-[#840029] text-sm hover:underline">
        ...
        return (
          <>
            ...
            <p className="mb-4">
              ...
              <a href={process.env.NEXT_PUBLIC_LOGIN_URL} className="text-[#840029] hover:underline">
                Click here
              </a>{" "}
